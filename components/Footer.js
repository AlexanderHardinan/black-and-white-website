...
export default function Footer() {
  return (
    <footer className="border-t border-white/10 mt-10">
      <div className="container py-3 sm:py-4 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-white/70">
        <div>© {new Date().getFullYear()} The Culinary World Gazette</div>
        ...
        <div className="flex items-center gap-4">
          ...
          {/* Instagram */}
          <a href="https://instagram.com/" aria-label="Instagram" className="hover:text-[var(--gold)]" target="_blank" rel="noopener noreferrer">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden>
          ...
          {/* Facebook */}
          <a href="https://facebook.com/" aria-label="Facebook" className="hover:text-[var(--gold)]" target="_blank" rel="noopener noreferrer">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden>
          ...
          {/* X / Twitter */}
          <a href="https://x.com/" aria-label="X" className="hover:text-[var(--gold)]" target="_blank" rel="noopener noreferrer">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden>
          ...
          {/* YouTube */}
          <a href="https://youtube.com/" aria-label="YouTube" className="hover:text-[var(--gold)]" target="_blank" rel="noopener noreferrer">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden>
